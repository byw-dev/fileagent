...
- 当前态与下一步候选：`docs/tasks/active.md`（core-completeness 收官 + D-022…D-025 已合并；下一步候选=元数据6c Phase1 实现 / webui 重做实现 / 可选 proto→buf）+ `docs/tasks/core-completeness.md`；Phase 3 主线 `docs/tasks/phases/phase-3.md`
