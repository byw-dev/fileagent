...
**IC-5（PR #100）、IC-2b（PR #103）、IC-3（PR #105）、D-034（PR #106）与 IC-4a（2026-09）均已收官。下一刀在 IC-4b（② 收尾）/ IC-15 之间选，彼此可并行**（**IC-SEC-2 已随 PR #109 收官、IC-BUG-44/43 已随 PR #108 收官、IC-4a 已收官**，均不再是候选），
之后才是有时间窗口的地基 IC-6/7。
