...
**IC-5（PR #100）、IC-2b（PR #103）、IC-3（PR #105）与 D-034（PR #106）均已收官。下一刀在 IC-4 / IC-15 / IC-BUG-44 之间选，彼此可并行**（**IC-SEC-2 已随 PR #109 收官**，IC-BUG-44/43 已随 PR #108 收官——两者均不再是候选），
之后才是有时间窗口的地基 IC-6/7。
...
**53 条中已关闭 33 条**（2026-09-17 更新：PR #108 新立 IC-BUG-53；2026-09-13：IC-3 另关 47、D-034/PR #106 关 50；49 已撤销）：IC-1 关 1/3/4/16/17/18/22/23，IC-SEC-1 关 24/25，IC-2c 关 19，
...
**未关闭 19 条：4 条挡、12 条可推、3 条拆半**（13、**46** 与 **32**；**12 与 31 均已两半齐全**；32 的拆半判于 PR #109——空闲路径随 IC-SEC-2 关闭、积压下送达保证未排期）。
...
> **下一刀在 IC-4 / IC-SEC-2 / IC-15 / IC-BUG-44 之间选**（彼此可并行；IC-3 与 D-034 均已收官）。IC-2a 的 live 验收过程中新立了
