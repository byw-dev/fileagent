...
> **缺陷清单**：[`bugs/open.md`](bugs/open.md) IC-BUG-1…IC-BUG-49
...
**IC-5（PR #100）、IC-2b（PR #103）与 IC-3 均已收官。下一刀在 IC-4 / IC-SEC-2 / IC-15 / IC-BUG-44 之间选，彼此可并行**，
之后才是有时间窗口的地基 IC-6/7。
...
**IC-2b（PR #103）关 20/21/30**，**IC-3（PR #105）关 5/39/47 并挡掉 46 的出血半边**（ILM 兜底一条见卡片——当前 MinIO 全代系不实现该 action，脚本照写并响亮告警）。
...
> **下一刀在 IC-4 / IC-SEC-2 / IC-15 / IC-BUG-44 之间选**（彼此可并行；IC-3 已收官）。IC-2a 的 live 验收过程中新立了
