...
**IC-5（PR #100）与 IC-2b（PR #103）均已收官。下一刀在 IC-3 / IC-4 / IC-SEC-2 之间选，三者彼此可并行**，
...
**45 条中已关闭 27 条**：IC-1 关 1/3/4/16/17/18/22/23，IC-SEC-1 关 24/25，IC-2c 关 19，
**IC-2a（PR #98）关 2/8/28/29/33**，**PR #97 关 35/36**，**IC-5（PR #100）关 10/11/34/37 并补上 12 的超时半边**。
**未关闭 18 条：5 条挡、12 条可推、1 条拆半**（仅 13 仍是拆半；**12 与 31 均已两半齐全**）。
**IC-2b（PR #103）关 20/21/30 并补齐 31 的结构半边**——重判时点名的两条产品语义缺口至此**全部关闭**
（10 随 IC-5，21 随 IC-2b）。
「挡」的 5 条是 5/6/7/9/40——**其中 6/7 是「挡（收窄）」，仍算挡，不要当成可推**。
