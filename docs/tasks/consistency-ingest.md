...
**IC-2b（PR #103）关 20/21/30**，**IC-3（PR #105）关 5/39/47 并挡掉 46 的出血半边**（ILM 兜底一条见卡片——当前 MinIO 全代系不实现该 action，脚本照写并响亮告警），**D-034（PR #106）关 50**，**PR #108（IC-BUG-44/43）关 43/44**，**IC-SEC-2（PR #109）关 26/27**，**IC-4a 关 6/9**（webhook 失败语义 + 毒丸 + 死信表 + `queue_dir` 持久卷；**IC-BUG-7 仍开着，归 IC-4b**）。
