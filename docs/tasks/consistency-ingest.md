...
**49 条中已关闭 29 条**：IC-1 关 1/3/4/16/17/18/22/23，IC-SEC-1 关 24/25，IC-2c 关 19，
...
**未关闭 20 条：5 条挡、14 条可推、1 条拆半**（仅 13 仍是拆半；**12 与 31 均已两半齐全**）。
**IC-2b（PR #103）关 20/21/30 并补齐 31 的结构半边**——重判时点名的两条产品语义缺口至此**全部关闭**
（10 随 IC-5，21 随 IC-2b）。
「挡」的 5 条原是 5/6/7/9/40（**其中 6/7 是「挡（收窄）」，仍算挡，不要当成可推**）——**5 已随 IC-3 关闭**，**新增 46**（tail 静默丢数据，🔴 P0），现为 **6/7/9/40/46**。
