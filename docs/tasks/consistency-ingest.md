...
> **缺陷清单**：[`bugs/open.md`](bugs/open.md) IC-BUG-1…IC-BUG-51
...
**51 条中已关闭 31 条**（2026-09-13 更新：IC-3 另关 47、D-034/PR #106 关 50；49 已撤销）：IC-1 关 1/3/4/16/17/18/22/23，IC-SEC-1 关 24/25，IC-2c 关 19，
...
**未关闭 19 条：4 条挡、13 条可推、2 条拆半**（13 与 **46**；**12 与 31 均已两半齐全**）。
