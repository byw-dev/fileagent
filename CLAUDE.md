...
追踪 `docs/tasks/consistency-ingest.md`，缺陷 `docs/tasks/bugs/open.md`（IC-BUG-1…IC-BUG-41，已关 18 条）。
...
**全新环境从来签不出 STS**，PR #97）→ **下一刀在 IC-2b / IC-3 / IC-4 / IC-5 / IC-SEC-2 之间选（可并行）**
