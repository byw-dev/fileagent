...
追踪 `docs/tasks/consistency-ingest.md`，缺陷 `docs/tasks/bugs/open.md`（IC-BUG-1…IC-BUG-49，已关 29 条）。
...
**IC-3** 🔄（续传落盘 + 孤儿分片清理，PR #105，**五轮 review 后收尾中**）→ **下一刀在 IC-4 / IC-SEC-2 之间选（可并行）**
