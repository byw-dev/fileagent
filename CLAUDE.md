...
追踪 `docs/tasks/consistency-ingest.md`，缺陷 `docs/tasks/bugs/open.md`（IC-BUG-1…IC-BUG-45，已关 23 条）。
...
**全新环境从来签不出 STS**，PR #97）→ **IC-5** ✅（采集正确性，PR #100）→ **下一刀在 IC-2b / IC-3 / IC-4 / IC-SEC-2 之间选（可并行，推荐 IC-2b）**
